...
export class Synthetic__derivativeStorageResultFixedParametersStruct extends EthereumTuple {
...
export class Synthetic__derivativeStorageResultExternalAddressesStruct extends EthereumTuple {
  get sponsor(): Address {
...
export class Synthetic__derivativeStorageResultReferenceTokenStateStruct extends EthereumTuple {
...
export class Synthetic__derivativeStorageResultCurrentTokenStateStruct extends EthereumTuple {
  get underlyingPrice(): BigInt {
    return this[0].toBigInt();
  }
...
export class Synthetic__derivativeStorageResultDisputeInfoStruct extends EthereumTuple {
...
export class Synthetic__derivativeStorageResultWithdrawThrottleStruct extends EthereumTuple {
...
export class Synthetic__derivativeStorageResult {
  ...
  constructor(
    value0: Synthetic__derivativeStorageResultFixedParametersStruct,
    value1: Synthetic__derivativeStorageResultExternalAddressesStruct,
    value2: BigInt,
    value3: BigInt,
    value4: i32,
    value5: BigInt,
    value6: Synthetic__derivativeStorageResultReferenceTokenStateStruct,
    value7: Synthetic__derivativeStorageResultCurrentTokenStateStruct,
    value8: BigInt,
    value9: Synthetic__derivativeStorageResultDisputeInfoStruct,
    value10: BigInt,
    value11: Synthetic__derivativeStorageResultWithdrawThrottleStruct
  ) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
...
export class Synthetic__getUpdatedUnderlyingPriceResult {
  value0: BigInt;
  value1: BigInt;
...
export class Synthetic extends SmartContract {
  static bind(address: Address): Synthetic {
    return new Synthetic("Synthetic", address);
  }
  ...
  derivativeStorage(): Synthetic__derivativeStorageResult {
    let result = super.call("derivativeStorage", []);

    return new Synthetic__derivativeStorageResult(
      result[0].toTuple() as Synthetic__derivativeStorageResultFixedParametersStruct,
      result[1].toTuple() as Synthetic__derivativeStorageResultExternalAddressesStruct,
      result[2].toBigInt(),
      result[3].toBigInt(),
      result[4].toI32(),
      result[5].toBigInt(),
      result[6].toTuple() as Synthetic__derivativeStorageResultReferenceTokenStateStruct,
      result[7].toTuple() as Synthetic__derivativeStorageResultCurrentTokenStateStruct,
      result[8].toBigInt(),
      result[9].toTuple() as Synthetic__derivativeStorageResultDisputeInfoStruct,
      result[10].toBigInt(),
      result[11].toTuple() as Synthetic__derivativeStorageResultWithdrawThrottleStruct
    ) as Synthetic__derivativeStorageResult;
  }

  try_derivativeStorage(): CallResult<Synthetic__derivativeStorageResult> {
    let result = super.tryCall("derivativeStorage", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
    return CallResult.fromValue(new Synthetic__derivativeStorageResult(
      value[0].toTuple() as Synthetic__derivativeStorageResultFixedParametersStruct,
      value[1].toTuple() as Synthetic__derivativeStorageResultExternalAddressesStruct,
      value[2].toBigInt(),
      value[3].toBigInt(),
      value[4].toI32(),
      value[5].toBigInt(),
      value[6].toTuple() as Synthetic__derivativeStorageResultReferenceTokenStateStruct,
      value[7].toTuple() as Synthetic__derivativeStorageResultCurrentTokenStateStruct,
      value[8].toBigInt(),
      value[9].toTuple() as Synthetic__derivativeStorageResultDisputeInfoStruct,
      value[10].toBigInt(),
      value[11].toTuple() as Synthetic__derivativeStorageResultWithdrawThrottleStruct
    ) as Synthetic__derivativeStorageResult);
  }
  ...
  getUpdatedUnderlyingPrice(): Synthetic__getUpdatedUnderlyingPriceResult {
    let result = super.call("getUpdatedUnderlyingPrice", []);

    return new Synthetic__getUpdatedUnderlyingPriceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getUpdatedUnderlyingPrice(): CallResult<
    Synthetic__getUpdatedUnderlyingPriceResult
  > {
    ...
    return CallResult.fromValue(
      new Synthetic__getUpdatedUnderlyingPriceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
