...
export class Contract__derivativeStorageResultFixedParametersStruct extends EthereumTuple {
...
export class Contract__derivativeStorageResultExternalAddressesStruct extends EthereumTuple {
  get sponsor(): Address {
...
export class Contract__derivativeStorageResultReferenceTokenStateStruct extends EthereumTuple {
...
export class Contract__derivativeStorageResultCurrentTokenStateStruct extends EthereumTuple {
  get underlyingPrice(): BigInt {
    return this[0].toBigInt();
  }
...
export class Contract__derivativeStorageResultDisputeInfoStruct extends EthereumTuple {
...
export class Contract__derivativeStorageResultWithdrawThrottleStruct extends EthereumTuple {
...
export class Contract__derivativeStorageResult {
  ...
  constructor(
    value0: Contract__derivativeStorageResultFixedParametersStruct,
    value1: Contract__derivativeStorageResultExternalAddressesStruct,
    value2: BigInt,
    value3: BigInt,
    value4: i32,
    value5: BigInt,
    value6: Contract__derivativeStorageResultReferenceTokenStateStruct,
    value7: Contract__derivativeStorageResultCurrentTokenStateStruct,
    value8: BigInt,
    value9: Contract__derivativeStorageResultDisputeInfoStruct,
    value10: BigInt,
    value11: Contract__derivativeStorageResultWithdrawThrottleStruct
  ) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
...
export class Contract__getUpdatedUnderlyingPriceResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends SmartContract {
  ...
  derivativeStorage(): Contract__derivativeStorageResult {
    let result = super.call("derivativeStorage", []);

    return new Contract__derivativeStorageResult(
      result[0].toTuple() as Contract__derivativeStorageResultFixedParametersStruct,
      result[1].toTuple() as Contract__derivativeStorageResultExternalAddressesStruct,
      result[2].toBigInt(),
      result[3].toBigInt(),
      result[4].toI32(),
      result[5].toBigInt(),
      result[6].toTuple() as Contract__derivativeStorageResultReferenceTokenStateStruct,
      result[7].toTuple() as Contract__derivativeStorageResultCurrentTokenStateStruct,
      result[8].toBigInt(),
      result[9].toTuple() as Contract__derivativeStorageResultDisputeInfoStruct,
      result[10].toBigInt(),
      result[11].toTuple() as Contract__derivativeStorageResultWithdrawThrottleStruct
    ) as Contract__derivativeStorageResult;
  }

  try_derivativeStorage(): CallResult<Contract__derivativeStorageResult> {
    let result = super.tryCall("derivativeStorage", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
    return CallResult.fromValue(new Contract__derivativeStorageResult(
      value[0].toTuple() as Contract__derivativeStorageResultFixedParametersStruct,
      value[1].toTuple() as Contract__derivativeStorageResultExternalAddressesStruct,
      value[2].toBigInt(),
      value[3].toBigInt(),
      value[4].toI32(),
      value[5].toBigInt(),
      value[6].toTuple() as Contract__derivativeStorageResultReferenceTokenStateStruct,
      value[7].toTuple() as Contract__derivativeStorageResultCurrentTokenStateStruct,
      value[8].toBigInt(),
      value[9].toTuple() as Contract__derivativeStorageResultDisputeInfoStruct,
      value[10].toBigInt(),
      value[11].toTuple() as Contract__derivativeStorageResultWithdrawThrottleStruct
    ) as Contract__derivativeStorageResult);
  }
  ...
  getUpdatedUnderlyingPrice(): Contract__getUpdatedUnderlyingPriceResult {
    let result = super.call("getUpdatedUnderlyingPrice", []);

    return new Contract__getUpdatedUnderlyingPriceResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getUpdatedUnderlyingPrice(): CallResult<
    Contract__getUpdatedUnderlyingPriceResult
  > {
    ...
    return CallResult.fromValue(
      new Contract__getUpdatedUnderlyingPriceResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
